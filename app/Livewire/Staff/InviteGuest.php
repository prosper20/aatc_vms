...
class InviteGuest extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.staff.invite-guest', compact('floorOptions'));
    }
}
...
//         'guests.*.floor_of_visit' => 'required|string',
//         'guests.*.reasonType' => 'required|in:Official,Personal,Other',
//         'guests.*.customReason' => 'required_if:reasonType,Other|string|max:500',
//         'guests.*.reason' => 'required|string|max:500',
//         'guests.*.phone' => 'required|string|max:20',
//     ];
...
//         if (in_array($propertyName, ['name', 'email', 'organization', 'visit_date', 'visit_time', 'floor_of_visit', 'reason', 'phone'])) {
//             $this->saveCurrentGuest();
//         }
//     }
...
//         $this->reason = $this->reasonType === 'Other' ? $this->customReason : $this->reasonType;
...
//         // $this->emit('visitCreated', $visit->id);
//         $this->dispatch('visitCreated', visitId: $visit->id);

//         // Reset form
//         $this->reset();

//         session()->flash('message', 'Guest invitation sent successfully!');
//     }
