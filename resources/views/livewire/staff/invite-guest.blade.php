                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {{-- <div class="mb-6 sm:col-span-2">
                                ...
                                <select wire:model="reasonType" id="reason_type" required
                                ...
                                @if($reasonType === 'Other')
                                    <textarea wire:model="reason" id="visit_reason" rows="3" required
                                              class="w-full py-3 px-4 border border-gray-300 rounded-xl bg-slate-50 focus:outline-none focus:border-emerald-300 focus:bg-white"
                                              placeholder="Please specify the reason for visit"></textarea>
                                @else

                                    <input type="hidden" wire:model="reason" value="{{ $reasonType }}">
                                @endif
                            ...
                            {{-- <div class="mb-6 sm:col-span-2" wire:key="guest-{{ $currentGuestIndex }}">
                                ...
                                @if($reasonType === 'Other')
                                    <div class="mt-2">
                                        ...
                                        <textarea wire:model="customReason" id="custom_reason" rows="3" required
                                                  class="w-full py-3 px-4 border border-gray-300 rounded-xl bg-slate-50 focus:outline-none focus:border-emerald-300 focus:bg-white"
                                                  placeholder="Enter your specific reason for visit"></textarea>
                                        @error('customReason') <span class="text-red-500 text-sm">Error setting reason</span> @enderror
                                    </div>
                                @endif
...
{{-- <div>
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-2">Invite New Guest</h2>
        <p class="text-gray-600">Send an invitation to a guest to visit your organization.</p>
    </div>
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" wire:model="name"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#007570] focus:border-transparent"
                       placeholder="Enter guest's full name">
                @error('name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" wire:model="organization"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#007570] focus:border-transparent"
                       placeholder="Guest's organization">
                @error('organization') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                <input type="time" wire:model="visit_time"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#007570] focus:border-transparent">
                @error('visit_time') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">
                    Floor of Visit <span class="text-red-500">*</span>
                </label>
                <select wire:model="floor_of_visit"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#007570] focus:border-transparent">
                    <option value="">Select floor</option>
                    @foreach($floorOptions as $value => $label)
                        <option value="{{ $value }}">{{ $label }}</option>
            ...
            <div class="md:col-span-2">
                ...
                <textarea wire:model="reason" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#007570] focus:border-transparent"
                          placeholder="Brief description of the visit purpose"></textarea>
                @error('reason') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
        </div>
        ...
        <div class="flex justify-end">
            <button type="submit"
                    ...
                    class="px-6 py-2 bg-[#007570] text-white font-medium rounded-md hover:bg-[#005d57] focus:outline-none focus:ring-2 focus:ring-[#007570] focus:ring-offset-2 disabled:opacity-50">
