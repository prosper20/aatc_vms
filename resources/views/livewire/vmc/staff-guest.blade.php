<div>
    <div class="max-w-7xl">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-2">Register Guests For Staff</h2>
            <p class="text-gray-600">Fill out the form below to register a guest on behalf of a host.</p>
        </div>
