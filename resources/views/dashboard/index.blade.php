                ...
                <div class="flex-1 max-w-2xl mx-4">
                    <form method="GET" action="{{ route('sm.dashboard') }}" class="relative">
                        ...
                        <input type="text" name="search"
                               class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:border-[#d3f2ee] focus:bg-white transition-colors duration-200"
